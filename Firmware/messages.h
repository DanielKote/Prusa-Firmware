...
extern const char MSG_BED_LEVELING_PICKING_UP_CLICKY[];
extern const char MSG_BED_LEVELING_DROPPING_OFF_CLICKY[];
extern const char MSG_BED_LEVELING_FAILED_POINT_LOW[];
extern const char MSG_BED_LEVELING_FAILED_CLICKY_PIN_NOT_FOIND[];
extern const char MSG_BED_LEVELING_FAILED_CANT_DEPOSIT_CLICKY_PIN[];
